...
hl.bind("CTRL + SUPER + R", hl.dsp.exec_cmd("killall ydotool qs quickshell 2>/dev/null; for i in $(seq 1 30); do pgrep -x qs > /dev/null || pgrep -x quickshell > /dev/null || break; sleep 0.1; done; setsid qs -c \"${qsConfig:-ii}\" > /dev/null 2>&1 &"),
...
hl.bind("SUPER + SHIFT + S", hl.dsp.exec_cmd(grimhyprctl .. " - | wl-copy"),
